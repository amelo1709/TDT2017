...
$(document).ready(function () {
    ...
    //Deshabilita el bot�n volver para evitar volver al Splash (index.html)
    //disableBack();
...
function loadOradores() {
    $.each(configuracion.oradores, function (i, item) {
        $("#oradores").append('<div class="col-xs-4" style="min-height:180px"><img src="' + configuracion.oradores[i].imagen + '" class="img-responsive img-circle"/><span class="small"><strong>' + configuracion.oradores[i].nombre + '</strong></span><hr/></div>');
    })
}